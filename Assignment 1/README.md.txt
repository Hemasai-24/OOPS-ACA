# Here I have tried to list all the CMD commands I have learnt with a short description of what it does.
...
####help displays a list of all the available commands.If a particular command interests you,type help followed by name of that command